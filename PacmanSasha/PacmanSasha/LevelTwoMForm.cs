...
{
    public partial class frmLevelTwoM : Form
    {
        ...
        WMPLib.WindowsMediaPlayer level2MPlayer;

        public frmLevelTwoM(ref WMPLib.WindowsMediaPlayer player, bool mute, bool levelTwo, bool levelThree)
        {
            InitializeComponent();
        ...
        private void mniBack_Click(object sender, EventArgs e)
        {
            ...
            new frmMainMenu(ref level2MPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void mniRestart_Click(object sender, EventArgs e)
        {
            ...
            new frmLevelTwoM(ref level2MPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void tmrPlay_Tick(object sender, EventArgs e)
        {
            ...
            if (score == 50)
            {
                ...
                new frmYouWin2(ref level2MPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (lives == 0)
            {
                ...
                new frmGameOver(ref level2MPlayer, muteForm, level2, level3).Show();
            }
