...
{
    public partial class frmLevelOneP : Form
    {
        ...
        WMPLib.WindowsMediaPlayer level1PPlayer;

        public frmLevelOneP(ref WMPLib.WindowsMediaPlayer player, bool mute, bool levelTwo, bool levelThree)
        {
            InitializeComponent();
        ...
        private void mniBack_Click(object sender, EventArgs e)
        {
            ...
            new frmMainMenu(ref level1PPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void mniRestart_Click(object sender, EventArgs e)
        {
            ...
            // display the level one with Pacman form
            new frmLevelOneP(ref level1PPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void tmrPlay_Tick(object sender, EventArgs e)
        {
            ...
            if (picYellowGhost.Bounds.IntersectsWith(picWall22.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost2 = -ghost2;
            }
            ...
            else if (picYellowGhost.Bounds.IntersectsWith(picWall18.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost2 = -ghost2;
            }
            ...
            if (picBlueGhost.Bounds.IntersectsWith(picWall17.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost4 = -ghost4;
            }
            ...
            foreach (Control x in this.Controls)
            {
                ...
                if (x is PictureBox && x.Tag == "ghost")
                {
                    ...
                    if (((PictureBox)x).Bounds.IntersectsWith(picPacman.Bounds))
                    {
                        // if muteForm is false
                        if (muteForm == false)
                        {
            ...
            if (score == 50)
            {
                ...
                new frmYouWin1(ref level1PPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (lives == 0)
            {
                ...
                new frmGameOver(ref level1PPlayer, muteForm, level2, level3).Show();
            }
            ...
            // if the pink ghost insersects with the wall31 image
            if (picPinkGhost.Bounds.IntersectsWith(picWall25.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall29 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall23.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall28 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall22.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall1 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall1.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall4 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall4.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
        ...
        private void KeyIsDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.KeyCode == Keys.Right)
            {
                ...
                // display the right Pacman image
