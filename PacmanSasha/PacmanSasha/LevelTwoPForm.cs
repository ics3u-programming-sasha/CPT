...
{
    public partial class frmLevelTwoP : Form
    {
        ...
        WMPLib.WindowsMediaPlayer level2PPlayer;

        public frmLevelTwoP(ref WMPLib.WindowsMediaPlayer player, bool mute, bool levelTwo, bool levelThree)
        {
            InitializeComponent();
        ...
        private void mniBack_Click(object sender, EventArgs e)
        {
            ...
            new frmMainMenu(ref level2PPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void mniRestart_Click(object sender, EventArgs e)
        {
            ...
            new frmLevelTwoP(ref level2PPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void tmrPlay_Tick(object sender, EventArgs e)
        {
            ...
            else if (picYellowGhost.Bounds.IntersectsWith(picWall21.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost2 = -ghost2;
            }
            ...
            if (picBlueGhost.Bounds.IntersectsWith(picWall20.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost4 = -ghost4;
            }
            ...
            if (score == 50)
            {
                ...
                new frmYouWin2(ref level2PPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (lives == 0)
            {
                ...
                new frmGameOver(ref level2PPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (picPinkGhost.Bounds.IntersectsWith(picWall1.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall5 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall5.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall6 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall6.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall7 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall7.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            else if (picPinkGhost.Bounds.IntersectsWith(picWall8.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall25 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall25.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
