...
{
    public partial class frmLevelOneM : Form
    {
        ...
        WMPLib.WindowsMediaPlayer level1MPlayer;

        public frmLevelOneM(ref WMPLib.WindowsMediaPlayer player, bool mute, bool levelTwo, bool levelThree)
        {
            InitializeComponent();
        ...
        private void mniBack_Click(object sender, EventArgs e)
        {
            ...
            new frmMainMenu(ref level1MPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void mniRestart_Click(object sender, EventArgs e)
        {
            ...
            new frmLevelOneM(ref level1MPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void tmrPlay_Tick(object sender, EventArgs e)
        {
            ...
            if (score == 50)
            {
                ...
                new frmYouWin1(ref level1MPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (lives == 0)
            {
                ...
                new frmGameOver(ref level1MPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (picPinkGhost.Bounds.IntersectsWith(picWall26.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
            ...
            // if the pink ghost insersects with the wall30 image
            else if (picPinkGhost.Bounds.IntersectsWith(picWall24.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost3x = -ghost3x;
                ghost3y = -ghost3y;
