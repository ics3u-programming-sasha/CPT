...
{
    public partial class frmLevelThreeP : Form
    {
        ...
        WMPLib.WindowsMediaPlayer level3PPlayer;

        public frmLevelThreeP(ref WMPLib.WindowsMediaPlayer player, bool mute, bool levelTwo, bool levelThree)
        {
            InitializeComponent();
        ...
        private void mniBack_Click(object sender, EventArgs e)
        {
            ...
            new frmMainMenu(ref level3PPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void mniRestart_Click(object sender, EventArgs e)
        {
            ...
            new frmLevelThreeP(ref level3PPlayer, muteForm, level2, level3).Show();
        }
        ...
        private void tmrPlay_Tick(object sender, EventArgs e)
        {
            ...
            if (picBlueGhost.Bounds.IntersectsWith(picWall13.Bounds))
            {
                // the ghost will travel in the opposite direction
                ghost4 = -ghost4;
            }
            ...
            if (score == 50)
            {
                ...
                new frmYouWin2(ref level3PPlayer, muteForm, level2, level3).Show();
            }
            ...
            if (lives == 0)
            {
                ...
                new frmGameOver(ref level3PPlayer, muteForm, level2, level3).Show();
            }
